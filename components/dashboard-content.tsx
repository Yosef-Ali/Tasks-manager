      ...
      <div className="flex justify-between items-center">
        <Tabs defaultValue="all" className="w-auto">
          <TabsList className="bg-card border border-border">
            <TabsTrigger value="all" className="text-sm data-[state=active]:bg-muted">
              All Tasks
            </TabsTrigger>
            <TabsTrigger value="pending" className="text-sm data-[state=active]:bg-muted">
              Pending
            </TabsTrigger>
            <TabsTrigger value="completed" className="text-sm data-[state=active]:bg-muted">
              Completed
            </TabsTrigger>
          </TabsList>
        </Tabs>
        ...
        <div className="flex items-center space-x-2">
          <div className="relative">
            <input
              ...
              className="pl-3 pr-10 py-2 border border-border rounded-md text-sm focus:outline-none focus:ring-1 focus:ring-primary focus:border-primary"
            />
          </div>
          <Button variant="outline" size="sm" className="flex items-center text-sm font-normal border-border">
  ...
  return (
    <div className="bg-white rounded-lg border border-gray-200 shadow-sm p-6">
      ...
      <div className="flex items-baseline mt-2">
        ...
        <div
          className={`ml-2 text-xs font-medium ${changeType === "positive" ? "text-green-500" : changeType === "negative" ? "text-red-500" : "text-gray-500"
            }`}
        >
          {change}
        </div>
...
function ActivityRow({ avatar, name, action, department, time, status }: ActivityRowProps) {
  return (
    <tr>
      ...
      <td className="px-6 py-4 whitespace-nowrap">
        <span
          className={`px-2 py-1 inline-flex text-xs leading-4 font-medium rounded-full ${status === "pending"
