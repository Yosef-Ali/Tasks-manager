...
export function SortableTableRow({ item }: SortableTableRowProps) {
    ...
    return (
        <tr
            ref={setNodeRef}
            style={style}
            className={`${isDragging ? "bg-secondary/50" : ""} border-b border-border transition-colors hover:bg-secondary/20`}
        >
